  ...
  return (
    <div 
      ...
      style={{
        ...
        // Check mobile devices to allow touch scrolling
        touchAction: /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          navigator.userAgent
        ) ? 'auto' : 'none',
        scrollBehavior: 'auto',
        overscrollBehavior: /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          navigator.userAgent
        ) ? 'auto' : 'none'
      }}
    >
